...
public class DeviceEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private CharSequence charging_source;
   ...
   */
  public DeviceEvent(CharSequence id, Integer charging, CharSequence charging_source, Integer current_capacity, Integer moduleL_temp, Integer moduleR_temp, Integer processor1_temp, Integer processor2_temp, Integer processor3_temp, Integer processor4_temp, Integer inverter_state, Integer SoC_regulator) {
    this.id = id;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: charging = (Integer)value$; break;
    case 2: charging_source = (CharSequence)value$; break;
    case 3: current_capacity = (Integer)value$; break;
    case 4: moduleL_temp = (Integer)value$; break;
    case 5: moduleR_temp = (Integer)value$; break;
    case 6: processor1_temp = (Integer)value$; break;
    case 7: processor2_temp = (Integer)value$; break;
    case 8: processor3_temp = (Integer)value$; break;
    case 9: processor4_temp = (Integer)value$; break;
    case 10: inverter_state = (Integer)value$; break;
    case 11: SoC_regulator = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public CharSequence getChargingSource() {
   ...
   * @param value the value to set.
   */
  public void setChargingSource(CharSequence value) {
   ...
   * @return A new DeviceEvent RecordBuilder
   */
  public static Builder newBuilder(DeviceEvent other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeviceEvent>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setCharging(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setChargingSource(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearChargingSource() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setModuleLTemp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearModuleLTemp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setModuleRTemp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearModuleRTemp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setProcessor1Temp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearProcessor1Temp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setProcessor2Temp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearProcessor2Temp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setProcessor3Temp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearProcessor3Temp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setProcessor4Temp(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearProcessor4Temp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setInverterState(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setSoCRegulator(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearSoCRegulator() {
    ...
    public DeviceEvent build() {
      try {
        ...
        record.charging = fieldSetFlags()[1] ? this.charging : (Integer) defaultValue(fields()[1]);
        record.charging_source = fieldSetFlags()[2] ? this.charging_source : (CharSequence) defaultValue(fields()[2]);
        record.current_capacity = fieldSetFlags()[3] ? this.current_capacity : (Integer) defaultValue(fields()[3]);
        record.moduleL_temp = fieldSetFlags()[4] ? this.moduleL_temp : (Integer) defaultValue(fields()[4]);
        record.moduleR_temp = fieldSetFlags()[5] ? this.moduleR_temp : (Integer) defaultValue(fields()[5]);
        record.processor1_temp = fieldSetFlags()[6] ? this.processor1_temp : (Integer) defaultValue(fields()[6]);
        record.processor2_temp = fieldSetFlags()[7] ? this.processor2_temp : (Integer) defaultValue(fields()[7]);
        record.processor3_temp = fieldSetFlags()[8] ? this.processor3_temp : (Integer) defaultValue(fields()[8]);
        record.processor4_temp = fieldSetFlags()[9] ? this.processor4_temp : (Integer) defaultValue(fields()[9]);
        record.inverter_state = fieldSetFlags()[10] ? this.inverter_state : (Integer) defaultValue(fields()[10]);
        record.SoC_regulator = fieldSetFlags()[11] ? this.SoC_regulator : (Integer) defaultValue(fields()[11]);
        return record;
